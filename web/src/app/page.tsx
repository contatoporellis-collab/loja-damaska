          ...
          <Container className="flex flex-col items-start gap-3 py-8 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex flex-col gap-1">
              ...
              <p className="max-w-2xl text-sm leading-relaxed text-muted">
                В Ростове-на-Дону работаем под ключ: бесплатный замер и монтаж
                нашими мастерами. В другие регионы России отправим готовую
                маркизу с подробной видеоинструкцией по монтажу.
              </p>
            </div>
            <ButtonLink
              href="#zayavka"
