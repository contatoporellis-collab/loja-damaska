...
import { landingRostov as landing } from "@/data/landing-rostov";
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Маркизы DAMASKA в Ростове-на-Дону",
      },
    ],
  },
};
...
export default function RostovLandingPage() {
  const jsonLd = {
    ...
    areaServed: ["Ростов-на-Дону", "Аксай", "Батайск"],
      ...
      <main>
          ...
          <div className="relative grid aspect-[16/11] w-full grid-cols-2 overflow-hidden bg-sand sm:aspect-[21/9]">
            ...
            <div className="relative overflow-hidden">
              <Image
                ...
                alt="Маркизы DAMASKA для кафе-кулинарии в центре города"
                fill
                loading="lazy"
                sizes="50vw"
            ...
            <div className="relative overflow-hidden border-l-2 border-bone/80">
              <Image
                ...
                alt="Маркиза DAMASKA для террасы частного дома"
                fill
                loading="lazy"
                sizes="50vw"
                className="object-cover"
            ...
            <Container className="absolute inset-x-0 bottom-0">
              <div className="flex flex-col gap-2 pb-7">
                ...
                <span className="text-sm text-bone/80 sm:text-base">
                  Собственная фабрика с 2011 года · монтаж в Ростове-на-Дону
                </span>
              </div>
            </Container>
          </div>
          ...
          <Container className="flex flex-col gap-8">
            ...
            <div className="flex flex-col items-start gap-4 sm:flex-row sm:items-center sm:justify-between">
              <p className="max-w-xl text-sm leading-relaxed text-muted">
                ...
                Ростове-на-Дону — рассчитаем стоимость и зафиксируем в договоре.
              </p>
        ...
        <section className="section">
          <Container className="flex flex-col gap-10">
            ...
            {/* Наши работы — реальные объекты фабрики (дома + бизнес) */}
                      ...
                      >
                        ...
                        <figcaption className="flex flex-col gap-0.5 px-4 py-3">
                          ...
                          <span className="text-xs text-faint">
                            Работа фабрики DAMASKA · маркиза под ключ
                          </span>
                        </figcaption>
                      </figure>
                    ))}
          ...
          <Container className="flex flex-col items-start gap-3 py-8 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex flex-col gap-1">
              ...
              <p className="max-w-2xl text-sm leading-relaxed text-muted">
                Работаем также по Краснодару и всему Краснодарскому краю. В
                другие регионы России отправим готовую маркизу с подробной
